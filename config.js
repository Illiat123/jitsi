...
var config = {
    ...
    hosts: {
        ...
        muc: 'conference.' + subdomain + 'jitsi26.realyzer.net',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://jitsi26.realyzer.net/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    websocket: 'wss://jitsi26.realyzer.net/' + subdir + 'xmpp-websocket',
